      ...
      <div className="container mx-auto px-4 mb-24">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-center mb-8">
            ...
            <span className="px-4 text-lg font-medium text-lime-600 uppercase tracking-widest">
              Essentials
            </span>
            <div className="h-px bg-lime-500 w-16"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="prose prose-lg">
              ...
              <p className="text-xl leading-relaxed text-gray-700">
                Let's walk the streets with open eyes and notice what we can use
                to keep our home warmer, not to get wet or not to blow through
                it the wind. This encourages us to look at our environment
                differently and use valuable raw materials instead of sending
      ...
      <div className="container mx-auto px-4 mb-24">
        <div className="flex flex-col items-center mb-16">
          ...
          <h3 className="text-3xl font-bold text-center mb-4">
            Available materials & their uses
          </h3>
